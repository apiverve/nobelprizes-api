...
class nobelprizesWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/nobelprizes');
        }
        ...
        this.validationRules = {"firstname":{"type":"string","required":false},"lastname":{"type":"string","required":false},"category":{"type":"string","required":false},"year":{"type":"integer","required":false,"min":1901,"max":2030}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/nobelprizes`);
        }
    }
...
module.exports = nobelprizesWrapper;
