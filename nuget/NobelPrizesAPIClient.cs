...
namespace APIVerve.API.NobelPrizes
{
    ...
    /// <summary>
    /// Client for the NobelPrizes API
    /// </summary>
    public class NobelPrizesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/nobelprizes";
        ...
        {
            { "firstname", new ValidationRule { Type = "string", Required = false } },
            { "lastname", new ValidationRule { Type = "string", Required = false } },
            { "category", new ValidationRule { Type = "string", Required = false } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1901, Max = 2030 } }
        };
        ...
        public NobelPrizesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NobelPrizesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NobelPrizesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NobelPrizesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NobelPrizesQueryOptions options)
        {
        ...
        public ResponseObj Execute(NobelPrizesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NobelPrizesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NobelPrizesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NobelPrizesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NobelPrizesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NobelPrizesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NobelPrizesQueryOptions options)
        {
