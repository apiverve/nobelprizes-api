...
```gradle
dependencies {
    implementation 'com.github.apiverve:nobelprizes-api:1.1.12'
}
```
...
```java
import com.apiverve.nobelprizes.NobelPrizesAPIClient;
import com.apiverve.nobelprizes.APIResponse;
import com.apiverve.nobelprizes.APIException;

// Initialize the client
NobelPrizesAPIClient client = new NobelPrizesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/nobelprizes](https://docs.apiverve.com/ref/nobelprizes)
...
- **Documentation:** [https://docs.apiverve.com/ref/nobelprizes](https://docs.apiverve.com/ref/nobelprizes)
- **Issues:** [GitHub Issues](https://github.com/apiverve/nobelprizes-api/issues)
