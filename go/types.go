// Package nobelprizes provides a Go client for the Nobel Prizes API.
//
// For more information, visit: https://apiverve.com/marketplace/nobelprizes?utm_source=go&utm_medium=readme
package nobelprizes
...
// Request contains the parameters for the Nobel Prizes API.
//
// Parameters:
//   - firstname: string - The first name of the Nobel Prize winner to get information about
//   - lastname: string - The last name of the Nobel Prize winner to get information about
//   - category: string - The category of the Nobel Prize to get information about
//   - year: integer - The year of the Nobel Prize to get information about [min: 1901, max: 2030]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"year": {Type: "integer", Required: false, Min: float64Ptr(1901), Max: float64Ptr(2030)},
	}
...
// ResponseData contains the data returned by the Nobel Prizes API.
type ResponseData struct {
	Count int `json:"count"`
	FilteredOn []string `json:"filteredOn"`
	NobelPrizes []NobelPrizesItem `json:"nobelPrizes"`
}

// NobelPrizesItem represents an item in the NobelPrizes array.
type NobelPrizesItem struct {
	FirstName string `json:"firstName"`
	LastName string `json:"lastName"`
	Born string `json:"born"`
	Died string `json:"died"`
	Countryborn string `json:"countryborn"`
	CountrybornCode string `json:"countrybornCode"`
	Born city string `json:"born city"`
	DiedCountry string `json:"diedCountry"`
	DiedCountryCode string `json:"diedCountryCode"`
	DiedCity string `json:"diedCity"`
