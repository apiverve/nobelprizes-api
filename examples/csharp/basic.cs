    ...
    class NobelPrizesExample
    {
        ...
        static async Task<JsonDocument> CallNobelPrizesAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;firstname&quot;] &#x3D; &quot;Albert&quot;, [&quot;lastname&quot;] &#x3D; &quot;Einstein&quot;, [&quot;category&quot;] &#x3D; &quot;Physics&quot;, [&quot;year&quot;] &#x3D; &quot;1921&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Nobel Prizes API...\n");

            var result = await CallNobelPrizesAPI();
