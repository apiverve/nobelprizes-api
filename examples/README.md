# Nobel Prizes API - Examples

This folder contains example code for using the Nobel Prizes API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/nobelprizes',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/nobelprizes");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/nobelprizes](https://docs.apiverve.com/ref/nobelprizes)
